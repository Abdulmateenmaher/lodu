...
/// Reusable game-rules bottom sheet used by the setup screen.
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  _RuleToggle(
                    label: 'Team Play (4 Players Only)',
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    elevation: 6,
                    shadowColor:
                        AppTheme.accentBlueDeep.withValues(alpha: 0.5),
                  ),
                  child: const Text(
                    'Save',
                    style: TextStyle(
          ...
          child: Row(
            children: [
              AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  color: value
                      ? AppTheme.accentBlueDeep.withValues(alpha: 0.25)
                      : AppTheme.bgPanelAlt,
                ...
                child: Icon(
                  icon,
                  size: 18,
                  color: value ? AppTheme.accentBlue : AppTheme.textFaint,
                ),
              ),
              ...
              Switch(
                ...
                activeTrackColor:
                    AppTheme.accentBlueDeep.withValues(alpha: 0.4),
                inactiveThumbColor: AppTheme.textFaint,
                inactiveTrackColor: AppTheme.bgPanelAlt,
              ),
            ],
          ),
        ),
